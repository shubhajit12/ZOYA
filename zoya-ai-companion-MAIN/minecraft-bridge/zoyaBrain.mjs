  ...
  async function think() {
    ...
    try {
      ...
      const system = [
        ...
        "You have these current executable capabilities: idle and safe_roam.",
        "Other future capabilities are listed only so you can identify a useful goal, but you must not claim they were executed: explore, gather_basic_resources, follow_player, investigate_entity, mine, chop_tree, craft, eat, return_to_owner.",
